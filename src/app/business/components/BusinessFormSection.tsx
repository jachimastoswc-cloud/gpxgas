...
export default function BusinessFormSection() {
  return (
    <section className="py-20 bg-input border-b border-border" aria-label="Φόρμα επικοινωνίας για επιχειρήσεις">
      <div className="max-w-site mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            <p className="eyebrow text-accent mb-4">Επικοινωνία</p>
            ...
            <p className="text-muted leading-relaxed mb-8">
              Συμπληρώστε τη φόρμα και θα επικοινωνήσουμε μαζί σας για να συζητήσουμε τις ανάγκες σας και να σας αποστείλουμε αναλυτική προσφορά.
            </p>
          ...
          <LeadForm
            variant="business"
            title="Φόρμα Επικοινωνίας — Επιχειρήσεις"
            subtitle="Συμπληρώστε τα παρακάτω στοιχεία για να λάβετε προσφορά."
          />
        </div>
      </div>
    </section>
